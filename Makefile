...
CORE_SRCS := src/core/nes.c src/core/cpu.c src/core/apu.c src/core/mapper/mapper3.c
...
$(TARGET): $(CORE_SRCS) $(WIN_SRCS) include/nesemu.h src/core/nes_internal.h src/core/apu.h src/core/mapper/mapper3.h | $(BUILD_DIR)
	$(CC) $(CPPFLAGS) $(WIN_CPPFLAGS) $(CFLAGS) -o $@ $(CORE_SRCS) $(WIN_SRCS) $(WIN_LDFLAGS) $(WIN_LIBS)

$(TEST_TARGET): $(CORE_SRCS) $(TEST_SRCS) include/nesemu.h src/core/nes_internal.h src/core/apu.h src/core/mapper/mapper3.h | $(BUILD_DIR)
